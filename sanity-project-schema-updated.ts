...
/**
 * Updated Project Schema - Matches Hardcoded Project Structure
 * 
 * This schema matches the exact structure of the hardcoded projects
 * in app/projects/[slug]/data.ts
 * 
 * Copy this to your Sanity Studio: schemas/project.ts
 * Then update your schemas/index.ts to include it
 */

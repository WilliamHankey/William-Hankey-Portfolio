...
// Fallback used until testimonial documents are added in Sanity.
const FALLBACK_TESTIMONIALS = [
  {
    _id: "senzo",
    name: "Senzo",
    photo: "/assets/logos/senzo.jpg",
    quote:
...
export default function Testimonials() {
  ...
  return (
    <section
      id="testimonials"
      className="bg-gray-100 flex flex-col justify-center items-center py-12 lg:py-24 px-4 lg:px-16"
    >
